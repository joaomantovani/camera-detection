...
%%% Title and authors %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Camera Shot Identification using Machine Learning}
\author{Joao Pedro Mantovani\thanks{Is with the Institute of Computing, University of Campinas (Unicamp). \textbf{Contact}: \tt\small{jpm.mantovani45@gmail.com}}\\
...
%%% Add section %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Activities}
    \item Create an algorithm to recursive fetch all the photos of all the directories
    \item The first step, use the entire image (3200x3000) scale with the feature extractor
    \item As said in the article #2, wavelets were extracted, horizontal, diagonal and vertical
    \item Logistic regression applied using 80% of the training as train and 20% test
